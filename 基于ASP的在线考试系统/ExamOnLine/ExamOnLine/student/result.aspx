<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="result.aspx.cs" Inherits="ExamOnLine.student.result" %>
...
<body style="background-image:url(../Image/back_01.gif)" onkeydown="keydown2()" onload="showtime()">
