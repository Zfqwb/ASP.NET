<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentexam.aspx.cs" Inherits="ExamOnLine.student.studentexam" %>
...
<body style="background-image:url(../Image/back_01.gif)">
    ...
    <div style="text-align: center">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="350px" Width="698px">
            <br />
            <br />
